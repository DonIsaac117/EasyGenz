...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (vista === "instructor/ficha") {
    // Crear una nueva URL sin los parámetros de búsqueda
    const newUrl = `${window.location.pathname}?vista=instructor/ficha`;
...
function mostrarModal(id) {
  // Evita que la función se ejecute si el clic es en el td con el checkbox
  if (event.target.closest('td.checkbox-td')) {
    return;
  }
